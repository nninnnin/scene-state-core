...
var assertInvariants = esToolkit.curry(function(mode, state) {
...
var zNum = zod.z.number();
var zVec3Finite = zod.z.tuple([zNum, zNum, zNum]);
var z_v0 = zod.z.looseObject({
  version: zod.z.number().optional(),
  entities: zod.z.record(zod.z.string(), zod.z.any()).optional(),
  components: zod.z.object({
    transform: zod.z.record(zod.z.string(), zod.z.any()).optional()
  }).partial().optional()
});
var z_v1 = zod.z.looseObject({
  version: zod.z.literal(1),
  entities: zod.z.record(
    zod.z.string(),
    zod.z.object({
  ...
  components: zod.z.object({
    transform: zod.z.record(
      zod.z.string(),
      zod.z.object({
        position: zod.z.any().optional(),
        rotation: zod.z.any().optional(),
        scale: zod.z.any().optional()
      })
    ).default({})
  }).default({ transform: {} })
});
var z_v2 = zod.z.object({
...
zod.z.object({
  ...
  components: zod.z.object({
    ...
    mesh: zod.z.record(zod.z.string(), zod.z.string()).optional(),
    material: zod.z.record(zod.z.string(), zod.z.string()).optional()
  })
});
zod.z.object({
  version: zod.z.literal(CURRENT_SCHEMA_VERSION),
  entities: zod.z.record(
    zod.z.string(),
    zod.z.object({
      name: zod.z.string().min(1)
...
var zAnyVersion = zod.z.preprocess(
  preprocessor,
  zod.z.discriminatedUnion("version", [
    z_v0.extend({
      version: zod.z.literal(0)
    }),
...
var HistoryManager = class {
  ...
  execute(command) {
    ...
    if (esToolkit.isEqual(prev, next)) {
      return;
    }
    this.undoStack.push({
      label: command.type,
...
exports.ClearMaterialCommand = ClearMaterialCommand;
exports.ClearMeshCommand = ClearMeshCommand;
...
exports.SetMeshCommand = SetMeshCommand;
exports.SetTransformCommand = SetTransformCommand;
exports.Store = Store;
